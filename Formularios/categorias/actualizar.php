                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDC/editarDatos.php" method="post">
                            ...
                            $sql = "SELECT * FROM tbl_sucursal WHERE idSucursal =" . $_REQUEST['Id'];
                            $resultado = $conexion->query($sql);

                            $row = $resultado->fetch_assoc();
                            ?>
                            <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $row['idSucursal'] ?>">
                            <div class="mb-3">
                                <label for="nombreC" class="form-label">Nombre</label>
                                <input type="text" class="form-control" id="nombreC" name="nombreC" placeholder="Nombre de la sucursal" value="<?php echo $row['nombreSucursal'] ?>">
                            </div>
