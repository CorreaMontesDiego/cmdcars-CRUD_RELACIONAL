        ...
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th scope="row"><?php echo $resultado['idSucursal'] ?></th>
                            <th scope="row"><?php echo $resultado['nombreSucursal'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?Id=<?php echo $resultado['idSucursal'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?Id=<?php echo $resultado['idSucursal'] ?>" class="btn btn-outline-danger">
