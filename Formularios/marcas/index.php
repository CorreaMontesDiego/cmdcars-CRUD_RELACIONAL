...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">LISTADO DE ESTADOS</h1>
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th scope="row"><?php echo $resultado['idEstado'] ?></th>
                            <th scope="row"><?php echo $resultado['nombreEstado'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/marcas/actualizar.php?Id=<?php echo $resultado['idEstado'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?Id=<?php echo $resultado['idEstado'] ?>" class="btn btn-outline-danger">
